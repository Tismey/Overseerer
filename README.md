...
**Overseer** est un jeu de zombies développé avec **Unity**, inspiré de *Left 4 Dead*.  
Le projet met l’accent sur des mécaniques dynamiques de **spawn de zombies** et une **IA avancée**, rendant chaque partie unique et imprévisible.  
...
1. **Cloner le projet**  
   ```bash
   git clone https://github.com/ton-compte/overseer.git
